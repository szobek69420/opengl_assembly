...
alink.exe -subsys console -oPE build/test.o build/string.o build/window.o build/game_loop.o build/opengl.asm build/console.o build/memory.o glfw3dll.lib -o build/test.exe
